...
(function($) {
	...
	var settings = {
		...
		// Parallax?
			...
			// Performance tweak: turns off parallax if the viewport width exceeds this value
			parallaxLimit: 1680,
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			'global':	{ range: '*', href: '/resources/schedule/css/style.css', containers: 1140 },
			'wide':		{ range: '-1680', href: '/resources/schedule/css/style-wide.css', containers: 960 },
			'normal':	{ range: '-1080', href: '/resources/schedule/css/style-normal.css', containers: '95%', lockViewport: true },
			'narrow':	{ range: '-840', href: '/resources/schedule/css/style-narrow.css', grid: { gutters: 30 } },
			'mobile':	{ range: '-640', href: '/resources/schedule/css/style-mobile.css', grid: { collapse: true, gutters: 20 } }
		}
	});
			...
			if (settings.parallax) {
				...
				$window
					...
					.on('resize.overflow_parallax', function() {
						if ($window.width() > settings.parallaxLimit
